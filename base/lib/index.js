...
/**
* @name reinterpretInt64
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/strided/base/reinterpret-int64}
*/
setReadOnly( ns, 'reinterpretInt64', require( './../../base/reinterpret-int64' ) );

/**
* @name reinterpretUint64
* @memberof ns
* @readonly
* @type {Function}
* @see {@link module:@stdlib/strided/base/reinterpret-uint64}
*/
setReadOnly( ns, 'reinterpretUint64', require( './../../base/reinterpret-uint64' ) );
