...
-   <span class="signature">[`reinterpretUint64( x, offset )`][@stdlib/strided/base/reinterpret-uint64]</span><span class="delimiter">: </span><span class="description">reinterpret a `Uint64Array` as a `Uint32Array`.</span>
