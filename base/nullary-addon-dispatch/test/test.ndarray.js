...
tape( 'the function returns a function which dispatches to a fallback function when not provided a typed array', function test( t ) {
	var f;
	var x;
	...
	function fallback( N, dx, ax, sx, ox ) {
...
tape( 'the function returns a function which throws an error if unable to resolve a data type enumeration constant when provided a typed array', function test( t ) {
	...
	function fcn1() {
		f( x.length, 'beepboopfoobar', x, 1, 0 );
	}
