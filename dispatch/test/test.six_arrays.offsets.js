...
var quinary = require( './../../base/quinary' ).ndarray;
...
tape( 'the function returns a function which throws an error if not provided an integer for the first argument', function test( t ) {
	...
	data = [ quinaryClbk ];
	strided = dispatch( quinary, types, data, 25, 5, 1 );
	...
	function badValue( value ) {
		return function badValue() {
			...
			strided( value, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the second argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, value, x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', value, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the fourth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, value, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the fifth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, value, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the sixth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, value, y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided array-like object for the seventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 0, 'float64', value, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the eighth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, value, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the ninth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, value, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the tenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, value, z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided array-like object for the eleventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( z.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', value, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the twelfth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, value, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the thirteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, value, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the fourteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, value, w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided array-like object for the fifteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( w.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', value, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the sixteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, value, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the seventeenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, value, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the eighteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, value, u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided array-like object for the nineteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( u.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', value, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the twentieth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, value, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the twenty-first argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, value, 'float64', v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the twenty-second argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, value, v, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided array-like object for the twenty-third argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( v.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', value, 1, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an integer for the twenty-fourth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, value, 0 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a nonnegative integer for the twenty-fifth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, value );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided too many arguments', function test( t ) {
	...
	values = [
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v ],
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v, 1 ],
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v, 1, 0 ],
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v, 1, 0, 'float64', v ],
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v, 1, 0, 'float64', v, 1 ],
		[ x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0, 'float64', v, 1, 0, 'float64', v, 1, 0 ]
	];
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (output array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', value, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (first input array)', function test( t ) {
	...
	strided = dispatch( sum( ctx ), types, null, 25, 5, 1 );
	...
	function badValue( value ) {
		return function badValue() {
			strided( y.length, 'float64', value, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', value, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (third input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', value, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (fourth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', value, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (fifth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', value, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (first input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, value, x.length-1, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, value, y.length-1, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (third input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, value, z.length-1, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (fourth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, value, w.length-1, 'float64', u, 1, 0, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (fifth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, value, u.length-1, 'float64', v, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided negative stride is incompatible with the number of indexed elements, offset, and array length (output array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, value, v.length-1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if unable to resolve a strided array function supporting the provided array argument data types', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'generic', value, 1, 0 );
		};
	}
});
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; no data; only input arrays)', function test( t ) {
	...
	strided = dispatch( sum( ctx ), types, null, 25, 6, 0 );
	...
	strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
	...
	strided( x.length, 'float32', x, 1, 0, 'float32', y, 1, 0, 'float32', z, 1, 0, 'float32', w, 1, 0, 'float32', u, 1, 0, 'float32', v, 1, 0 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; no data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fill( 3.0 ), types, null, 25, 0, 6 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; no data; only input arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, null, 25, 6, 0 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; no data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, null, 25, 0, 6 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; data; only input arrays)', function test( t ) {
	...
	strided = dispatch( forEach, types, data, 25, 6, 0 );
	cnt = 0;
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; data; only output arrays)', function test( t ) {
	...
	strided = dispatch( map1N, types, data, 25, 0, 6 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; only input arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 25, 6, 0 );
	cnt = 0;
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 25, 0, 6 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; input and output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 25, 5, 1 );
...
tape( 'the function returns a function which returns one or more output arrays, if one or more output arrays is specified, and otherwise returns `undefined`', function test( t ) {
	...
	u = new Float64Array( x.length );
	v = new Float64Array( x.length );
	out = strided( x.length, 'float64', x, 1, 0, 'float64', y, 1, 0, 'float64', z, 1, 0, 'float64', w, 1, 0, 'float64', u, 1, 0, 'float64', v, 1, 0 );
	...
	strided = dispatch( fill( 3.0 ), types, null, 25, 5, 1 );
