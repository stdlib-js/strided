...
tape( 'the function returns a function which throws an error if not provided an integer for the first argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			strided( value, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the second argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, value, x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', value, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the fourth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, value, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the fifth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, value, y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the sixth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', value, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the seventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', y, value, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the eighth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', y, 1, value, z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an array-like object for the ninth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( z.length, 'float64', x, 1, 'float64', y, 1, 'float64', value, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an integer for the tenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, value, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the eleventh argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 0, value, w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an array-like object for the twelfth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( w.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', value, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an integer for the thirteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, value, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the fourteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, value, u, 1, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an array-like object for the fifteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( u.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', value, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the sixteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, value, 'float64', v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided a string for the seventeenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, value, v, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an array-like object for the eighteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( v.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', value, 1 );
		};
	}
});

tape( 'the function returns a function which throws an error if not provided an integer for the nineteenth argument', function test( t ) {
	var strided;
	var values;
	var types;
	var data;
	...
	function badValue( value ) {
		return function badValue() {
			...
			var u = new Float64Array( x.length );
			var v = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, value );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided insufficient arguments', function test( t ) {
	...
	values = [
		...
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64' ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1 ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64' ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64' ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1 ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v ]
	];
...
tape( 'the function returns a function which throws an error if provided too many arguments', function test( t ) {
	...
	values = [
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1, 'float64', v ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1, 'float64', v, 1 ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1, 'float64', v, 1, 'float64', v ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1, 'float64', v, 1, 'float64', v, 1 ]
	];
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (output array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', value, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (first input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( y.length, 'float64', value, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', value, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (third input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', value, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (fourth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', value, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (fifth input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', value, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided stride is incompatible with the number of indexed elements and an array length (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, value, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided stride is incompatible with the number of indexed elements and an array length (fifth input array)', function test( t ) {
	var strided;
	var values;
	var types;
	var ctx;
...
tape( 'the function returns a function which throws an error if unable to resolve a strided array function supporting the provided array argument data types', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'generic', value, 1 );
		};
	}
});
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; no data; only input arrays)', function test( t ) {
	...
	strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
	...
	strided( x.length, 'float32', x, 1, 'float32', y, 1, 'float32', z, 1, 'float32', w, 1, 'float32', u, 1, 'float32', v, 1 );
...
tape( 'the function returns a function which returns one or more output arrays, if one or more output arrays is specified, and otherwise returns `undefined`', function test( t ) {
	...
	u = new Float64Array( x.length );
	v = new Float64Array( x.length );
	out = strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', u, 1, 'float64', v, 1 );
