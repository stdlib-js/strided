...
tape( 'the function returns a function which throws an error if not provided an integer for the first argument', function test( t ) {
	...
	data = [ ternaryClbk ];
	strided = dispatch( ternary, types, data, 13, 3, 1 );
	...
	function badValue( value ) {
		return function badValue() {
			...
			strided( value, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the second argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, value, x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
tape( 'the function returns a function which throws an error if not provided an array-like object for the third argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', value, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the fourth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', x, value, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the fifth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, value, y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the sixth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', value, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the seventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', y, value, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the eighth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( y.length, 'float64', x, 1, 'float64', y, 1, value, z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the ninth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( z.length, 'float64', x, 1, 'float64', y, 1, 'float64', value, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the tenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, value, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided a string for the eleventh argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, value, w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an array-like object for the twelfth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( w.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', value, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if not provided an integer for the thirteenth argument', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			...
			var z = new Float64Array( x.length );
			var w = new Float64Array( x.length );
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, value );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided too many arguments', function test( t ) {
	...
	values = [
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', w ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', w, 1 ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', w, 1, 'float64', w ],
		[ x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1, 'float64', w, 1, 'float64', w, 1 ]
	];
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (output array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', value, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (first input array)', function test( t ) {
	...
	strided = dispatch( sum( ctx ), types, null, 13, 3, 1 );
	...
	function badValue( value ) {
		return function badValue() {
			strided( y.length, 'float64', value, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', value, 1, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if provided an array with an insufficient number of elements (third input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', value, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if a provided stride is incompatible with the number of indexed elements and an array length (second input array)', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, value, 'float64', z, 1, 'float64', w, 1 );
		};
	}
});
...
tape( 'the function returns a function which throws an error if unable to resolve a strided array function supporting the provided array argument data types', function test( t ) {
	...
	function badValue( value ) {
		return function badValue() {
			strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'generic', value, 1 );
		};
	}
});
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; no data; only input arrays)', function test( t ) {
	...
	strided = dispatch( sum( ctx ), types, null, 13, 4, 0 );
	...
	strided( x.length, 'float32', x, 1, 'float32', y, 1, 'float32', z, 1, 'float32', w, 1 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; no data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fill( 3.0 ), types, null, 13, 0, 4 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; no data; only input arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, null, 13, 4, 0 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; no data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, null, 13, 0, 4 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; data; only input arrays)', function test( t ) {
	...
	strided = dispatch( forEach, types, data, 13, 4, 0 );
	cnt = 0;
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function; data; only output arrays)', function test( t ) {
	...
	strided = dispatch( map1N, types, data, 13, 0, 4 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; only input arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 13, 4, 0 );
	cnt = 0;
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; only output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 13, 0, 4 );
...
tape( 'the function returns a function which invokes a callback for indexed strided array elements (function array; data; input and output arrays)', function test( t ) {
	...
	strided = dispatch( fcns, types, data, 13, 3, 1 );
...
tape( 'the function returns a function which returns one or more output arrays, if one or more output arrays is specified, and otherwise returns `undefined`', function test( t ) {
	...
	z = new Float64Array( x.length );
	w = new Float64Array( x.length );
	out = strided( x.length, 'float64', x, 1, 'float64', y, 1, 'float64', z, 1, 'float64', w, 1 );
	...
	strided = dispatch( fill( 3.0 ), types, null, 13, 3, 1 );
