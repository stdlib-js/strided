...
interface Dispatcher {
	...
	*
	* @example
	* var nullary = require( './../../../base/nullary-by' );
	...
	*
	* @example
	* var nullary = require( './../../../base/nullary-by' ).ndarray;
	* var Float64Array = require( '@stdlib/array/float64' );
	...
	*
	* @example
	* var unary = require( './../../../base/unary-by' );
	* var Float64Array = require( '@stdlib/array/float64' );
	...
	*
	* @example
	* var unary = require( './../../../base/unary-by' ).ndarray;
	* var Float64Array = require( '@stdlib/array/float64' );
	* var abs = require( '@stdlib/math/base/special/abs' );
	* var identity = require( '@stdlib/math/base/special/identity' );
	*
	...
	*
	* @example
	* var binary = require( './../../../base/binary-by' );
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	* function add2( x, y ) {
	*     return x + y;
	...
	*
	* @example
	* var binary = require( './../../../base/binary-by' ).ndarray;
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	* function add2( x, y ) {
	*     return x + y;
	...
	*
	* @example
	* var ternary = require( './../../../base/ternary-by' );
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	* function add3( x, y, z ) {
	*     return x + y + z;
	...
	*
	* @example
	* var ternary = require( './../../../base/ternary-by' ).ndarray;
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	* function add3( x, y, z ) {
	*     return x + y + z;
	...
	*
	* @example
	* var quinary = require( './../../../base/quinary-by' );
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	...
	*
	* @example
	* var quinary = require( './../../../base/quinary-by' ).ndarray;
	* var Float64Array = require( '@stdlib/array/float64' );
	*
	* function add5( x, y, z, w, u ) {
	*     return x + y + z + w + u;
