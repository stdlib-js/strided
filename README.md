...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { base, dispatch, dtypes } from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided@v0.3.1-esm/index.mjs';
```
