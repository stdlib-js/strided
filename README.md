...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided@v0.3.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided/actions/workflows/test.yml/badge.svg?branch=v0.3.3
[test-url]: https://github.com/stdlib-js/strided/actions/workflows/test.yml?query=branch:v0.3.3
